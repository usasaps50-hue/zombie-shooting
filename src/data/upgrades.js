...
export const UPGRADES = {
  pistol: {
    ...
    levels: [
      ...
      { cost: 200, healOnKill: 5, desc: 'ピストルで倒すとHPが5回復' },
      { cost: 500, invulnOnKill: 0.2, desc: 'ピストルで倒すと0.2秒だけ無敵' },
      { cost: 750, magazine: 12, gold: true, unlocks: 'ak47', desc: '見た目が金色／弾12発／AK47のレベル3が開放' },
    ],
  },
  shovel: {
    id: 'shovel',
...
export function upgradedItem(itemId, level) {
  ...
  if (base.damage) item.damage = Math.round(base.damage * (1 + DAMAGE_PER_LEVEL * (level - 1)));
